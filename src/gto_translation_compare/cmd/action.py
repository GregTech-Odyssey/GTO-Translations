...
from gto_translation_compare.utils.github_action import set_output
import httpx
from dulwich import porcelain
from loguru import logger

from gto_translation_compare import settings
from gto_translation_compare.filetypes import FiletypeLang, Language, FiletypeGTLang, Filetype
from gto_translation_compare.modpack.modpack import ModPack
from gto_translation_compare.paratranz.client_wrapper import ClientWrapper
from gto_translation_compare.paratranz.converter import Converter
from gto_translation_compare.paratranz.paratranz_cache import ParatranzCache
from gto_translation_compare.paratranz.types import StringItem, TranslationFile
from gto_translation_compare.utils.file import ensure_lf
...
class Action:
    ...
    async def _save_daily_modpack_history(
        ...
        qb_lang_file_url = (
            ...
            f"/{settings.GTO_REPO}/master/{settings.DEFAULT_QUESTS_LANG_TEMPLATE_REL_PATH}"
        )
