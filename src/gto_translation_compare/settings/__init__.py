...
from gto_translation_compare.utils.env import must_get_env

# NOTE: DO NOT MODIFY THE DEFAULT VALUE IN THE CODE, USE ENVIRONMENT VARIABLES TO OVERRIDE
TARGET_LANG = Language.from_str(os.environ.get("TARGET_LANG", "zh_CN"))

GTO_REPO = os.environ.get("GTO_REPO", "GregTech-Odyssey/GTO-Translations")
